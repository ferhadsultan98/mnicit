...
const CareersSection = () => {
  ...
  const benefits = [
    { icon: <FaDollarSign />, title: 'Rəqabətli Maaş' },
    { icon: <FaHeart />, title: 'Səhiyyə Sığortası' },
    { icon: <FaGraduationCap />, title: 'Təhsil Dəstəyi' },
    { icon: <FaCoffee />, title: 'Çevik İş' },
    { icon: <FaGamepad />, title: 'Oyun Otağı',  },
    { icon: <FaPlane />, title: 'İllik Məzuniyyət' }
  ];
