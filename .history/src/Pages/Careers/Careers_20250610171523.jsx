      ...
      <div className="careersContainer">
        <div className="careersHeader">
          ...
          <p className="careersSubtitle">
            SAP və qeyri-SAP xidmətlərinin ön sıralarında olan dinamik
            komandamıza qoşulun! Biz sizə əməkdaşlıq mühitində yeniliklər etmək
            və yüksəliş üçün güc verən bir sıra karyera imkanları təklif edirik.
            Potensialınızı bizimlə kəşf edin və biznes həlləri sahəsində
            gələcəyinizi formalaşdırmağa nail olun!
          </p>
        </div>
