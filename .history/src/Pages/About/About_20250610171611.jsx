...
import { Code, Shield, Zap, Users, Award, ArrowRight, CheckCircle } from 'lucide-react';
import '../../Styles/AboutSection.scss'

const AboutSection = () => {
  const teamMembers = [
    { name: "Elvin Məmmədov", position: "Baş Developer", email: "elvin@company.com" },
    { name: "Aygün Həsənova", position: "UI/UX Dizayner", email: "aygun@company.com" },
    { name: "Rəşad Əliyev", position: "Layihə Meneceri", email: "rashad@company.com" },
    { name: "Nigar Quliyeva", position: "Kiber Təhlükəsizlik Mütəxəssisi", email: "nigar@company.com" },
  ];
        ...
        <div className="headerContent">
          <div className="headerText">
            ...
            <p className="subtitle">
              PM Systems, innovativ həllər və peşəkar məsləhətlər ilə biznesinizi inkişaf etdirməyə sadiqdir. Peşəkar komandamız hər layihə üçün dəqiq və yüksək keyfiyyətli nəticələr təmin etmək üçün ən müasir texnologiyalardan istifadə edir. Biz sistemlərin optimallaşdırılması və layihələrin idarə edilməsi ilə əlaqədar xüsusi dəstəyi təmin edərək sizin uğurunuza və böyüməyinizə fokuslanırıq.
            </p>
          </div>
        ...
        <div className="mainContent">
          <div className="contentText">
            ...
            <p className="contentDescription">
              İT sənayesində illərlə təcrübə ilə biz biznesin inkişafını və rəqəmsal 
              transformasiyasını təmin edən hərtərəfli həllər təqdim edirik. Sertifikatlı 
              mütəxəssislərimizdən ibarət komandamız texnologiya infrastrukturunuzun möhkəm, 
              təhlükəsiz və ölçülənə bilən olmasını təmin edir.
            </p>
          ...
          <div className="contentVisual">
            <div className="visualCard">
              ...
              <div className="cardContent">
                <p>Sizin çətinliklərinizi həll etməyə hazır peşəkar mütəxəssislər</p>
